...
parser.add_argument(
    "--sample_interval", type=int, default=50, help="interval between image sampling"
)
...
dataset = datasets.ImageFolder(root=local_image_folder, transform=transform)
